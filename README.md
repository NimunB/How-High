...
One inspiration for this work was [Facework](https://facework.app/) by KyleMcDonald, where users are given instructions to follow, but then realize there is greater value in disobeying them. Another inspiration for the look of the piece is Francesca Brierley’s project called [you Home now](https://www.behance.net/gallery/124250113/you-HOME-now-PoseNet?tracking_source=search_projects|posenet&l=4), where I really liked the disconnected cut-out look of her alien and used it to inspire how I placed body parts upon a Black screen. 
